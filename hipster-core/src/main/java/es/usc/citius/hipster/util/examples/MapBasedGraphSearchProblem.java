 ...
 */
public class MapBasedGraphSearchProblem<S> implements HeuristicSearchProblem<S, S, Double> {

    private S begin;
    private S goal;
    private TransitionFunction<S,S> transitionFunction;
    private CostFunction<S, S, Double> costFunction;
    ...
    @Override
    public TransitionFunction<S, S> getTransitionFunction() {
    ...
    @Override
    public CostFunction<S, S, Double> getCostFunction() {
        return costFunction;
    }
}
