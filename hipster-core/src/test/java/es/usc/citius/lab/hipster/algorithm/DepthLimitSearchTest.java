 ...
 * 
 */
public class DepthLimitSearchTest extends DepthFirstSearchTest {
    ...
    public void testTree(){
        ...
        Iterator<UnweightedNode<String, String>> iterator =
                Hipster.createDepthLimitedSearch(GraphSearchProblem.startingFrom("A").in(tree).build()).iterator();
    ...
    public void testGraphWithoutCycles(){
        ...
        Iterator<UnweightedNode<String, String>> iterator =
                Hipster.createDepthLimitedSearch(GraphSearchProblem.startingFrom("A").in(graph).build()).iterator();
