...
public final class MazeSearch {
    ...
    public static Result executePrintIteratorSearch(Iterator<AStarNode<Point>> it, StringMaze maze) throws InterruptedException {
        int steps = 0;
        while (it.hasNext()) {
            AStarNode<Point> currentNode = it.next();
            steps++;
    ...
    public static Result executeIteratorSearch(Iterator<AStarNode<Point>> it, StringMaze maze) {
        int steps = 0;
        while (it.hasNext()) {
            AStarNode<Point> currentNode = it.next();
            steps++;
