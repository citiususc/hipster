...
public class InformedNodeFactory<S, T extends Comparable<T>> implements NodeFactory<S, HeuristicNode<S,T>> {
	...
	public InformedNodeFactory(CostFunction<S,T> costFunction, HeuristicFunction<S, T> heuristicFunction, BinaryOperation<T> accumulator){
		this.gf = costFunction;
		this.hf = heuristicFunction;
		this.accumulator = accumulator;
	}
	
	public InformedNodeFactory(CostFunction<S,T> costFunction, BinaryOperation<T> accumulator){
		this.gf = costFunction;
