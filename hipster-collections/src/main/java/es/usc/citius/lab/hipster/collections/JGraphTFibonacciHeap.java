 ...
 */
public class JGraphTFibonacciHeap<T> {
     ...
     */
    public static <T> JGraphTFibonacciHeap<T> union(
            JGraphTFibonacciHeap<T> h1,
            JGraphTFibonacciHeap<T> h2) {
        JGraphTFibonacciHeap<T> h = new JGraphTFibonacciHeap<T>();
